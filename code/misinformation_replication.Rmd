...
rows <- tribble(~term, ~Combined, ~a, ~b, ~c, ~d, ~e, ~f,
                r'(\multicolumn{4}{l}{\textbf{Age}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r"(\cmidrule(lr){2-8})", '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Gender}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r"(\cmidrule(lr){2-8})", '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Political allegiance}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r"(\cmidrule(lr){2-8})", '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Digital literacy index}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r"(\cmidrule(lr){2-8})", '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Scientific knowledge index}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', ''
               )

attr(rows, 'position') <- c(1,8,
                            9,16,
                            17,24,
                            25,32,
                            33)

modelsummary(models, stars = TRUE, title = 'Heterogeneity under control, evaluation', add_rows = rows, escape = FALSE) # note: escape = F
...
modelsummary(models, 
             ...
             add_rows = rows,
             escape = FALSE,
             coef_rename = c('Age: Below median (n = 6104)' = r'(\hspace{1em} Below Median)',
                             'Age: Above median (n = 6030)' = r'(\hspace{1em} Above Median)',
                             'Age: Difference' = r'(\hspace{1em} Difference)',
                             'Male:  Not male (n = 5752)' = r'(\hspace{1em} Not male)',
                             'Male: Male (n = 6382)' = r'(\hspace{1em} Male)',
                             'Male: Difference' = r'(\hspace{1em} Difference )',
                             'Political Allegiance:  Not aligned (n = 8609)' = r'(\hspace{1em} Not aligned)',
                             'Political Allegiance: Aligned w/ ruling party (n = 3525)' = r'(\hspace{1em} Aligned w/ ruling party)',
                             'Political Allegiance: Difference' = r'(\hspace{1em} Difference  )',
                             'Digital literacy index: Below median (n = 6186)' = r'(\hspace{1em} Below median )',
                             'Digital literacy index: Above median (n = 5948)' = r'(\hspace{1em} Above median )',
                             'Digital literacy index: Difference' = r'(\hspace{1em}  Difference)',
                             'Scientific beliefs index: Below median (n = 6463)' = r'(\hspace{1em} Below median  )',
                             'Scientific beliefs index: Above median (n = 5671)' = r'(\hspace{1em} Above median  )',
