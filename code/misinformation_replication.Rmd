...
round(mean(x)*100,1)
mean(x)/mean(aipw_scores_any_false[,1])
mean(x)/mean(aipw_scores_any_false_restricted[,1])
...
1-  mean( (aipw_scores_any_false[,4]+ aipw_scores_any_false[,1])[which(optimal_assignment == 4)])/mean( (aipw_scores_any_false[,5]+ aipw_scores_any_false[,1])[which(optimal_assignment == 4)] )
# the reverse is true for participants assigned Facebook tips
mean( (aipw_scores_any_false[,4]+ aipw_scores_any_false[,1])[which(optimal_assignment == 5)])/mean( (aipw_scores_any_false[,5]+ aipw_scores_any_false[,1])[which(optimal_assignment == 5)] )
