...
rows <- tribble(~term, ~Combined, ~FalseAnySharing, ~FalseMessenger, ~FalseTimeline, ~TrueAnySharing, ~TrueMessenger, ~TrueTimeline,
                ...
                r'(\multicolumn{3}{l}{\textbf{Headline treatment effects}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r'(\multicolumn{3}{l}{\textbf{Respondent treatment effects}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r'(\hline)', '', '', '', '', '', '', ''
               )
...
rows <- tribble(~term, ~Combined, ~FalseAnySharing, ~FalseMessenger, ~FalseTimeline, ~TrueAnySharing, ~TrueMessenger, ~TrueTimeline,
                ...
                '', r'(\textbf{Combined})', 'Any sharing', 'Messenger', 'Timeline', 'Any sharing', 'Messenger', 'Timeline',
                r'(\cmidrule(lr){2-2} \cmidrule(lr){3-5} \cmidrule(lr){6-8})', '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Optimal assignment == Accuracy nudge (n = 4,967)}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r'(\cmidrule(lr){2-8})', '', '', '', '', '', '', '',
                r'(\multicolumn{4}{l}{\textbf{Optimal assignment == Facebook tips (n = 5,716)}} \rule{0pt}{1.2\normalbaselineskip})', '', '', '', '', '', '', '',
                r'(\cmidrule(lr){2-8})', '', '', '', '', '', '', '',
                r'(\hline)', '', '', '', '', '', '', '',
                r'(\textbf{Grand Difference})', '', '', '', '', '', '', ''
               )
...
modelsummary(models, stars = TRUE, title = 'Policy heterogeneity across respondent treatments, evaluation', add_rows = rows, escape = FALSE) 

modelsummary(models, 
             stars = TRUE,  
             title = 'Policy heterogeneity under pooled respondent treatment, evaluation', 
             add_rows = rows,
             escape = FALSE,
             coef_rename = c('Accuracy nudge: Accuracy nudge' = r'(\hspace{1em}Accuracy)',
                             ...
                             'Grand difference: Grand difference' = ''), 
             output = '../tables/heterogeneity_policy.tex')
