...
df_treat <- df_treat |> 
  mutate(optimal0 = c(rep(1, n()-length(h2)), wopt_multi_forest),
  ...
  filter( (batch != 5) | ((probs_0 %in% c(0.025, 0.1666666667))),
...
# CLEANED_FILENAME <- paste0('cleaned-holdout-data_', 
#                            Sys.Date())
# write_rds(cbind(df_holdout[, c('ID','Y', 'W', context_cols, paste0('probs_', 0:39))]), 
#           paste0('../data/', CLEANED_FILENAME,'.rds'))
