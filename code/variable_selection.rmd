...
cols <- c(
          ...
          # `last_response`, instead of all these?
...
Variables that still need description:
...
Variables that needs fix to the description OR I have questions with OR should be deleted:
